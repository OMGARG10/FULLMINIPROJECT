...
import BeParent from './components/Admin/Parents/BeParent';
import DonationFooter from './components/Admin/Parents/DonationFooter';
import ParentNav from './components/Admin/Parents/ParentNav';
import ProfileCard from './components/Admin/Parents/Profilecard';
import Profile from "./components/Admin/Parents/Profile"
import ViewOrphan from "./components/Admin/Parents/ViewOrphan"
  ...
  return (
   <> 
    <Routes>
      ...
      <Route exact path ="/DonationFooter"element={<DonationFooter/>}/>
      <Route path='/ParentNav' element={<ParentNav/>}/>
